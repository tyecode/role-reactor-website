  ...
  return (
    <>
      <Dialog open={isOpen} onOpenChange={setOpen}>
        ...
        <DialogContent className="max-w-[400px] bg-black border-zinc-800 p-0 shadow-2xl overflow-hidden gap-0 rounded-[2rem]">
          {/* Header Section */}
          <div className="bg-zinc-900 mx-4 mt-4 mb-2 p-5 rounded-[1.5rem] border border-zinc-800">
