...
- **Core Credit System** - Credit-based economy for AI avatar generation
...
<Cards>
  <Card
    title="🎯 Easy Setup"
    description="Create role messages with simple slash commands - no complex configuration needed"
  />
  <Card
    title="📱 User Friendly"
    description="Members click emoji reactions - no commands to learn or remember"
  />
  <Card
    title="⏰ Temporary Roles"
    description="Auto-expire roles after set time periods with smart notifications"
  />
  <Card
    title="📅 Scheduled Roles"
    description="Assign roles at specific times or create recurring schedules"
  />
  <Card
    title="🎉 Welcome System"
    description="Auto-welcome new members with customizable messages and auto-role assignment"
  />
  <Card
    title="👋 Goodbye System"
    description="Auto-goodbye messages when members leave with customizable placeholders"
  />
  <Card
    title="🎤 Voice Permissions"
    description="Automatically enforces Connect/Speak restrictions for all role assignments"
  />
  <Card
    title="📊 XP System"
    description="Track member activity with configurable experience points and leaderboards"
  />
  <Card
    title="🎨 AI Avatar Generation"
    description="Generate unique anime-style avatars using AI with multiple style options"
  />
  <Card
    title="💎 Core Credit System"
    description="Credit-based economy for avatar generation with multiple acquisition options"
  />
  <Card
    title="📊 Poll System"
    description="Create and manage native Discord polls with interactive forms"
  />
  <Card
    title="🎱 8ball Game"
    description="Ask the magic 8ball questions and get random responses for entertainment"
  />
  <Card
    title="🗂️ Organized Categories"
    description="Group related roles with category headers for clean organization"
  />
  <Card
    title="🎨 Customizable"
    description="Choose colors, emojis, and formatting to match your server's style"
  />
  <Card
    title="🔒 Secure"
    description="Respects Discord's permission system and role hierarchy automatically"
  />
  <Card
    title="⚡ Reliable"
    description="Fast response times and automatic error handling for smooth operation"
  />
</Cards>

<AdBlock
  slot="docs_feed_overview"
  format="fluid"
...
<Cards>
  ...
  <Card
    title="📝 Examples"
    description="Ready-to-use setups for gaming, study, and community servers"
    href="/docs/examples"
  />
  <Card
...
<Callout type="success">
  **Ready to get started?** Review the [Getting
  Started](/docs/getting-started/introduction) guide to add Role Reactor Bot to
  your server.
</Callout>
