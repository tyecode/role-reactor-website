...
<Callout type="info">
  **Formatting Note:** Ensure there are no extra spaces around commas in the
  roles string. Use `🎮:Gamer,🎨:Artist` not `🎮:Gamer, 🎨:Artist`.
</Callout>
...
<Callout type="check">
  **Success:** Your members can now self-assign roles by reacting to your
  message.
</Callout>
