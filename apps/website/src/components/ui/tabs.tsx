  ...
  "flex items-center justify-center rounded-xl p-1 text-zinc-400 backdrop-blur-sm transition-all gap-1",
  {
    variants: {
      variant: {
        ...
        neon: "bg-zinc-950/80 border border-white/10 p-1 h-auto rounded-xl backdrop-blur-xl shadow-[0_0_30px_-10px_rgba(0,0,0,0.5)]",
      },
    },
    defaultVariants: {
      variant: "default",
  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg px-3 py-2.5 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500/50 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 ring-offset-zinc-950 flex-1",
  {
    variants: {
      variant: {
        ...
        neon: "rounded-lg px-3 sm:px-6 py-2.5 text-[11px] sm:text-xs font-black uppercase tracking-widest data-[state=active]:bg-cyan-500 data-[state=active]:text-black data-[state=active]:shadow-[0_0_20px_rgba(6,182,212,0.4)] hover:text-white",
        "neon-purple":
          "rounded-lg px-3 sm:px-6 py-2.5 text-[11px] sm:text-xs font-black uppercase tracking-widest data-[state=active]:bg-purple-500 data-[state=active]:text-white data-[state=active]:shadow-[0_0_20px_rgba(168,85,247,0.4)] hover:text-white",
      },
    },
    defaultVariants: {
      variant: "default",
