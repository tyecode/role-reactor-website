...
Get Role Reactor Bot up and running in your Discord server with this complete setup guide.
...
<Steps>
  <Step>
    **Invite the Bot**
    ...
    [Add Role Reactor Bot to your server](https://discord.com/oauth2/authorize?client_id=YOUR_BOT_ID&permissions=268435456&scope=bot%20applications.commands)
...
<Cards>
  <Card title="Edit Message" description="/update-roles - Update title, description, or roles" />
  <Card title="Delete Message" description="/delete-roles - Remove a role message" />
  <Card title="List Messages" description="/list-roles - See all your role messages" />
...
**Setting Role Colors:**
```
/role create name:"Gaming" color:"#FF0000" emoji:"🎮"
/role create name:"Music" color:"#00FF00" emoji:"🎵"
```
