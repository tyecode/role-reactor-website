---
title: Adding the Bot to Your Server
description: Get Role Reactor Bot up and running in your Discord server in just a few clicks
---
...
**Next:** Ready to create your first role message? Check out [First Setup](/getting-started/first-setup)!
