---
title: Your First Role Setup
description: Create your first role assignment message and see Role Reactor Bot in action
---
...
**Next Steps:**
- Learn more about [Basic Concepts](/getting-started/basic-concepts)
- Explore [Creating Advanced Role Messages](/role-setup/creating-messages)
- Check out [Example Setups](/examples/gaming-server) for your server type
