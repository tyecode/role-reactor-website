...
Create interactive role selection messages in Discord where members can choose roles by clicking emoji reactions. Perfect for gaming servers, study groups, communities, and more.

<Callout type="info">
**Quick Start:** Add the bot, run `/setup-roles`, and you'll have working role selection in under 2 minutes!
</Callout>
...
<Cards>
  <Card title="🚀 Getting Started" description="Add the bot and create your first role message in minutes" href="/getting-started" />
  <Card title="⚙️ Setup Guide" description="Complete configuration guide from basic to advanced features" href="/setup" />
  <Card title="💻 Commands" description="Full reference for all slash commands with examples" href="/commands" />
  <Card title="📝 Examples" description="Ready-to-use setups for gaming, study, and community servers" href="/examples" />
  <Card title="🔧 Troubleshooting" description="Solutions for common issues and helpful FAQ" href="/troubleshooting" />
</Cards>
...
**Ready to get started?** Check out the [Getting Started](/getting-started) guide to add Role Reactor Bot to your server!
</Callout>
