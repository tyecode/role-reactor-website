...
description: Solutions for common Role Reactor Bot issues and helpful troubleshooting guide
---
...
<Cards>
  <Card title="Manage Roles" description="Core permission - required for all role assignment" />
  <Card title="Send Messages" description="Required to create role messages" />
  <Card title="Use Slash Commands" description="Required for all commands" />
  <Card title="Add Reactions" description="Required to add emoji reactions" />
</Cards>
...
3. Look at [Common Issues](/troubleshooting/common-issues)
...
**Still need help?** Check out the [FAQ](/troubleshooting/faq) for more specific questions, or join our support server for community assistance!
</Callout>
